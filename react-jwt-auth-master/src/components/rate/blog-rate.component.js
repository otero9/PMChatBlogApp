...
export default class BlogRate extends Component {
  ...
  newPositiveRate() {
    RateService.rateBlog(this.props.dataFromParent.blogId,this.props.dataFromParent.currentUser.id,1);
    ...
    return (
      <React.Fragment>
        <div className="text-muted mb-4 text-center">
            <span className="text-muted text-center">What do you think about this blog?</span>
            <p/>
